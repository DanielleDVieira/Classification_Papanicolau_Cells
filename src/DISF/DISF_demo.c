...
// ./bin/DISF_demo ../../../recorteImg/dbb1bf3a7bced124e9f9012a950eb06b/1845.png 1000 10 ../../../recorteImg/dbb1bf3a7bced124e9f9012a950eb06b/segmented/1845.png
//=============================================================================
// Main
//=============================================================================
int main(int argc, char* argv[])
{
    ...
    Graph *graph;
    char outputPath[256], labelsName[255], bordersName[255];

    if(argc != 5) usage();
    img = loadImage(argv[1]);
    n_0 = atoi(argv[2]);
    n_f = atoi(argv[3]);
    strcpy(outputPath, argv[4]);
    ...
    sprintf(labelsName, "%s_labels.pgm", outputPath);
    sprintf(bordersName, "%s_borders.pgm", outputPath);
